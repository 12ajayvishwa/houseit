import 'package:get/get.dart';import 'chipviewlayout_item_model.dart';import 'layout20_item_model.dart';import 'package:houseit/data/models/selectionPopupModel/selection_popup_model.dart';import 'layout21_item_model.dart';import 'listshape4_item_model.dart';import 'gridshape6_item_model.dart';class PropertyDetailsModel {Rx<List<ChipviewlayoutItemModel>> chipviewlayoutItemList = Rx(List.generate(2,(index) =>ChipviewlayoutItemModel()));
